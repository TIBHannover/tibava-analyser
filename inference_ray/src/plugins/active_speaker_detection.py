...
from analyser.data import AnnotationData, Annotation, AudioData, FacesData, VideoData
...
class ActiveSpeakerDetection(
    ...
    def call(
        ...
        with inputs["video"] as video_data, inputs["audio"] as audio_data, inputs[
            "face_tracks"
        ] as face_tracks, data_manager.create_data("AnnotationData") as speaker_tracks:
            with audio_data.open_audio(
                "r"
            ) as audio_file, video_data.open_video() as video_file:
